  ...
  return (
    <div className="md:mt-32">
      <h1
        ...
        className="text-5xl font-bold text-center text-sky-900 py-8 md:pb-0"
      >
        Experience
      </h1>
      <div className="bg-violet-900 my-8 text-white">
            ...
            <div className="exp-description w-80 font-medium">
              ...
              <div>
                <div className="strategy flex items-center justify-center mt-4">
                  <img
                    className="border-2 border-black bg-white rounded-full p-1 w-16"
                    src={strategy}
                    alt=""
                  />
                ...
                <div className="mission flex items-center justify-center mt-4">
                  ...
                  />
                  <p className="text-sm pl-2">
                    My mission is to build an immigration agency and reach out
